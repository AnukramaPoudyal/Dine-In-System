...
loginButton.addEventListener("click", () => {
    ...
    if (email === "") {
        ...
        alert(
            "Invalid email format! Must be in the format 'example@example.com'"
        );
        isValid = false;
        return;
    }
            ...
            .then((data) => {
                if (data.message) {
                    if (
                        ...
                        // Redirect to dashboard upon successful login for admin
                        window.location.href = "../Frontend/dashboard.html";
                    } else {
                        // Redirect to homepage upon successful login for regular user
