...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function reserveTable(fullName, numberOfPeople, dateBooked, timeBooked, tableNumber, status) {

      // Make the GET request
      fetch(`/table/reservation?fullName=${fullName}&numberOfPeople=${numberOfPeople}&dateBooked=${dateBooked}&timeBooked=${timeBooked}&tableNumber=${tableNumber}&status=${status}`, {
          method: 'GET',
          headers: {
  ...
  // Example usage
  reserveTable('John Doe', 4, '2024-05-05', '18:00', 5, 'confirmed');
});
